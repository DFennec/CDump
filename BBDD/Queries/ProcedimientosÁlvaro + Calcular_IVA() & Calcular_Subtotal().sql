...
BEGIN
INSERT INTO FACTURAS(CODUSU,REF_VENTA,FECHA_VENTA,SUBTOTAL,IVA,TOTAL,METODOPAGO)VALUES((SELECT CODUSU FROM VENTAS WHERE REF=REF_VENTA),REF_VENTA,(SELECT FECHA FROM VENTAS WHERE REF=REF_VENTA),CALCULAR_SUBTOTAL(TOTAL_CARRITO((SELECT CODUSU FROM VENTAS WHERE REF=REF_VENTA))),CALCULAR_IVA(TOTAL_CARRITO((SELECT CODUSU FROM VENTAS WHERE REF=REF_VENTA))),TOTAL_CARRITO((SELECT CODUSU FROM VENTAS WHERE REF=REF_VENTA)),(SELECT METODOPAGO FROM VENTAS WHERE REF=REF_VENTA));
END
